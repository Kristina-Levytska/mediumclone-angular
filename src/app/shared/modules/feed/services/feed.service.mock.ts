...
const getFeedMock = (): GetFeedResponseInterface => ({
  articles: [
    ...
    },
    {
      ...
      favoritesCount: 99,
      slug: '',
      tagList: ['Simpsons', 'beer', 'storyOfMyLife'],
      title: 'Maaaarge',
